...
exports.config = {
    ...
    suites: {
        full : [
            './test/specs/login-valid.e2e.js',
            './test/specs/login-invalid.e2e.js',
            './test/specs/logout.e2e.js',
            './test/specs/sort-products.e2e.js',
            './test/specs/add-multiple-products.e2e.js',
            './test/specs/add-specific-product.e2e.js',
            './test/specs/complete-purchase.e2e.js',
        ]
    },
    // Patterns to exclude.
    exclude: [
